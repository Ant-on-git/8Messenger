...
***********     dp  sp  xp
все экраны разные по плотности и разрешению

px  =  конкретное количество пикселей.
        100 пикселей на экране с разрешением 1080 займут маленькую часть
                   а на экране с разрешением 200 займут пол экрана

dp = пиксели, не зависящие от плотности экрана. на любых экранах займет примерно одинаковую часть экрана

sp = то же самое что dp, только для шрифта. Но если в настройках андроида изменили размер шрифта, то sp то же изменится. dp нет
